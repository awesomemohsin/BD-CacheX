...
export function StatCard({
  ...
  return (
    <div className={`group bg-white p-6 rounded-2xl border border-slate-100 shadow-sm shadow-slate-100/30 hover:shadow-md hover:shadow-slate-200/40 hover:-translate-y-1 transition-all duration-300 ${className}`}>
